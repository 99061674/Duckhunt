...
function SchietenMiss(){
    ...
    if(misspunt == 20){
        alert("Je hebt verloren, punten: " + hitpunt + " Hit " + misspunt + " Miss ");
    }
}
...
function SchietenHit(event){
    ...
    if(hitpunt == 20){
        alert("Je hebt gewonnen, punten: " + hitpunt + " Hit " + misspunt + " Miss ");
    }
...
//If + Else
function vliegEend(){
    randomSide = sides[Math.floor(Math.random() * sides.length)];
